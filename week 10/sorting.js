...
const hikes = [
    ...
    function SearchHikesList(List, query) {
        ...
        const sortedResults = searchResults.sort((a, b) => a.distance - b.distance);
    ...
    console.log(SearchHikesList(hikes, "e"));
    ...
    const simpleSort = simpleList.slice().sort((a, b) => a.localeCompare(b));
    console.log("Simple Sort (Ascending):", simpleSort);
    ...
    // const compareDecending = simpleList.sort(compareFn);
    ...
    const ascendingSort = simpleList.slice().sort(compareAscending);
    console.log(ascendingSort);
    const descendingSort = simpleList.slice().sort(compareDescending);
    ...
    console.log(SearchList(simpleList, "c"));
    console.log(SearchList(simpleList, "t"))